...
(function (global) {
  ...
  var SUBJECTS = [
    ...
    { id: 'horse', art: 'horse', cat: 'life', dim: 'height', m: 1.6,
      en: ['Horse', 'Riding horse, at the withers'], it: ['Cavallo', 'Cavallo da sella, al garrese'],
      fEn: 'Measured at the shoulder, never at the head.',
      fIt: 'Si misura alla spalla, mai alla testa.' },
    ...
    { id: 'mouse', art: 'mouse', cat: 'life', dim: 'length', m: 0.09,
      en: ['House Mouse', 'Adult, head and body'], it: ['Topolino domestico', 'Adulto, testa e corpo'],
      fEn: 'It can squeeze through a gap the width of a pencil.',
      fIt: 'Riesce a passare in una fessura larga quanto una matita.' },
    { id: 'moose', art: 'moose', cat: 'life', dim: 'height', m: 1.9,
      en: ['Moose', 'Adult male, at the shoulder'], it: ['Alce', 'Maschio adulto, al garrese'],
    ...
    { id: 'squid', art: 'squid', cat: 'sea', dim: 'length', m: 10,
